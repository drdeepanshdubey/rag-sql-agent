...
class SQLAgent:
    ...
    def __init__(self, api_key: str, model: str, vector_store_dir: str):
        ...
        self._table_schemas: dict[str, dict] = {}    # table_name → schema dict
        self._tables: dict[str, pd.DataFrame] = {}   # table_name → DataFrame
