...
class SQLExecutor:
    ...
    def register_table(self, table_name: str, df: pd.DataFrame) -> None:
        ...
        """
        # DuckDB can query pandas DataFrames directly via Python variable
        ...
        # DuckDB's register() makes the DataFrame queryable via SQL
    ...
    def execute_with_retry(
        ...
        for attempt in range(1, max_retries + 1):
            ...
            if validation_error and attempt == 1:
                ...
                # Don't fail on syntax warning — DuckDB may still handle it
            ...
            try:
                ...
                # Non-DuckDB error (e.g., connection issue) — don't retry
                last_error = str(e)
